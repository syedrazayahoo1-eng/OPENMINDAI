...
public class UpdateAgentDto
{
    ...
    [Required, StringLength(60)] public string Status { get; set; } = string.Empty;
    [Required, StringLength(250)] public string CurrentTask { get; set; } = string.Empty;
    ...
    [Range(0, 1)] public decimal Temperature { get; set; }
    [Range(1, 128000)] public int MaxTokens { get; set; }
}
